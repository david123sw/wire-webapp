...
const config: ServerConfig = {
  CLIENT: {
    ...
    FEATURE: {
      ...
      ENABLE_COMPANY_LOGIN: process.env.FEATURE_ENABLE_COMPANY_LOGIN == 'false' ? false : true,
      ENABLE_COMPLEX_ACCOUNT_LOGIN: process.env.FEATURE_ENABLE_COMPLEX_ACCOUNT_LOGIN == 'false' ? false : true,
      ...
      ENABLE_SIMPLE_ACCOUNT_LOGIN: process.env.FEATURE_ENABLE_SIMPLE_ACCOUNT_LOGIN == 'false' ? false : true,
