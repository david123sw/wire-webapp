...
export class CryptographyMapper {
   ...
   * @param {Object} event - Event of BackendEvent.CONVERSATION.OTR-ASSET-ADD or BackendEvent.CONVERSATION.OTR-MESSAGE-ADD or BackendEvent.CONVERSATION.BGP-MESSAGE-ADD
