...
ko.components.register('asset-loader', {
  template: `
  <div class="media-button" data-bind="click: onCancel, css: {'audio-media-button-color-right': is_audio && audio_from_myself, 'audio-media-button-color-left': is_audio && !audio_from_myself}" data-uie-name="status-loading-media">
